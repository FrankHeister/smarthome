 ...
 */
package org.eclipse.smarthome.binding.bluetooth.eqivablue.internal;

import java.util.Collections;
import java.util.Set;

import org.eclipse.smarthome.binding.bluetooth.eqivablue.EqivaBlueBindingConstants;
import org.eclipse.smarthome.binding.bluetooth.eqivablue.handler.EqivaBlueHandler;
...
public class EqivaBlueHandlerFactory extends BaseThingHandlerFactory {
    ...
    protected ThingHandler createHandler(Thing thing) {
        ...
        if (thingTypeUID.equals(EqivaBlueBindingConstants.THING_TYPE_EQIVA_BLUE)) {
            return new EqivaBlueHandler(thing);
        }
